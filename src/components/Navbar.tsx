...
const Navbar = () => {
  return (
    <>
      <nav className="fixed top-0 inset-x-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-2xl">
      ...
      <div aria-hidden className="h-16 sm:h-[4.5rem]" style={{ paddingTop: "env(safe-area-inset-top)" }} />
    </>
  );
};
